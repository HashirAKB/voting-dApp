// This component is responsible for the admin screen
...
This function is used to get the details of all the candidates
*/
...
This function is used to get the current state of the election
*/
...
This function is used to open the dialog box for ending the election
*/
  const handleEnd = () => {
    setOpen(true);
  };
...
This function is used to start or end the election based on the current state
*/
...
This is the UI for the Admin component
*/
  return (
    <Box>
      {loading ? (
